                                ...
                                <div className="wrapper">
                                        <div className="lg:max-w-md">
                                                ...
                                                <div className="space-y-5 mt-7 pe-10">
                                                        ...
                                                        <p>
                                                                A brand-new display engine delivers breathtaking precision, color accuracy, and brightness. And a next-gen GPU with hardware-accelerated ray tracing brings gaming-console-level graphics to your fingertips.
                                                        </p>
